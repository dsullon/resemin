      ...
      <div id="modalLogin" class="modal">
          <div class="modal-content">
              ...
              <div class="center-align">
                  ...
                  <form class="col s12" ng-controller="LoginController" name="frmLogin">
                      <div class="row center-align">
                          ...
                          <div class="input-field col m10 offset-m1 blue-text ">
                              ...
                              <input id="icon_password" type="password" class="validate" required ng-model="user.clave">
                  ...
                  <p>
                      ...
                      <a href="#" class="waves-effect waves-blue blue btn btn-flat modal-action modal-close" 
                      ng-disabled="frmLogin.$invalid">Login</a>
                  </p>
              </div>
          </div>
      </div>
